...
class PNGLoader
{
	...
	void handlePixel(SColor pixel, int offset)
	{
		...
		{
			spawnBlob(map, "backladder", offset, 255);
			offsets[autotile_offset].push_back(offset);
		}
		...
		else if(pixel == color_ballg)
		{
			spawnBlob(map, "ballg", offset, -1, false);
			offsets[autotile_offset].push_back(offset);
		}
		...
		else if(pixel == color_balld)
		{
			spawnBlob( map, "balld", offset, -1, false);
			offsets[autotile_offset].push_back(offset);
		}
